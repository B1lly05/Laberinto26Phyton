...
from Laberinto26.Modo import Perezoso
from Laberinto26.Orientaciones import Sur
...
ruta = r"C:\Uni\3º ESIIAB\2º cuatri\Diseño\Prácticas\Archivos Json\Laberinto26-4Habs-bichos.json"
...
mi_juego.agregar_personaje("Arturo")
...
print("> Trato de que Arturo camine hacia el Sur desde la Habitación 1...")
if getattr(mi_laberinto.obtener_habitacion(1).sur, 'EsPuerta', lambda: False)():
    print("¡Efectivamente, en el sur de la Hab 1 hay una puerta!")
    mi_laberinto.obtener_habitacion(1).sur.entrar(mi_juego.personaje)
