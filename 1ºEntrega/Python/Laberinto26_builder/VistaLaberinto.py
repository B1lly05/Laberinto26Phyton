...
import io
# Configuramos la consola a UTF-8 para que soporte los Emojis
...
from Laberinto26.Orientaciones import Este, Norte, Oeste, Sur
...
class VistaLaberinto_Clase:
    ...
    def _configurar_emojis(self):
        ...
        self.t_suelo = "⬛"
        self.t_prota = "🤺" # Nuestro héroe Arturo
    ...
    def dibujar_habitacion(self, habitacion):
        ...
        def pintar_orilla(elemento, y, x):
            if elemento is not None:
                if getattr(elemento, 'EsPuerta', lambda: False)():
                    if getattr(elemento, 'abierta', False):
        ...
        pintar_orilla(habitacion.norte, 0, 2)
        pintar_orilla(habitacion.sur, 4, 2)
        pintar_orilla(habitacion.este, 2, 4)
        pintar_orilla(habitacion.oeste, 2, 0)
...
if __name__ == "__main__":
    ...
    ruta_json_prueba = r"C:\Uni\3º ESIIAB\2º cuatri\Diseño\Prácticas\Archivos Json\Laberinto26-4Habs-bichos.json"
